<style>
    ...
    @if(isset($advertisement))
        <form action="{{ route('UpdateAdvertisement') }}" method="POST" style="width: 100%" id="advertisementForm" enctype="multipart/form-data">
            {{ method_field('PUT') }}
            @else
                <form action="{{ route('storeAdvertisement') }}" method="POST" style="width: 100%"
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            <label>Order</label>
                            <input type="text" placeholder="Order" @if(isset($advertisement)) value="{{ $advertisement->order }}" @endif name="order" class="form-control">
                        </div>
