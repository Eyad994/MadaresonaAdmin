            ...
            <form action="{{ route('user.store') }}" method="POST" id="userForm">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label>Name</label>
                        <input type="text" class="form-control" name="name" placeholder="Name" @if(isset($user)) value="{{ $user->name }}" @endif>
                    </div>
                    <div class="col-md-6 form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" name="email" placeholder="Email" @if(isset($user)) value="{{ $user->email }}" @endif>
                    </div>
                    <div class="col-md-6 form-group">
                        <label>Type</label>
