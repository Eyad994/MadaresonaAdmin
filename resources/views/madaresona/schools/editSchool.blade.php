                                ...
                                <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="email" class="form-control" id="email_school"
                                                   name="email_school"
                                ...
                                <div id="step-5" class="tab-pane" role="tabpanel" aria-labelledby="step-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select class="form-control" id="discounts_superior"
                                                    name="discounts_superior">
                                                @if(isset($school))
                                                    @foreach($trueFalseArray as $index => $value)
                                                        <option value="{{ $index }}"
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select class="form-control" id="discounts_brothers"
                                                    name="discounts_brothers">
                                                @if(isset($school))
                                                    @foreach($trueFalseArray as $index => $value)
                                                        <option value="{{ $index }}"
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select class="multiple-select" name="gender[]" multiple="multiple"
                                                    id="gender">
                                                @if(!isset($school))
