        ...
        var table = $('#newsTable').DataTable({
            ...
            columns: [
...

                {
                    ...
                    var remove = '<a href="#" class="btn btn-sm btn-clean btn-icon action-btn remove-news-btn" id="' + row.id + '" data-toggle="tooltip" data-placement="bottom" title="Remove"><i class="far fa-trash-alt" style="color: #f64e60"></i></i></a>';
                    var edit = '<a href="#" class="btn btn-sm btn-clean btn-icon action-btn edit-news-btn" id="' + row.id + '" data-toggle="tooltip" data-placement="bottom" title="Remove"><i class="fa fa-edit" style="color: #00aff0"></i></i></a>';
                    return edit + remove;
                }
                }
            ]
