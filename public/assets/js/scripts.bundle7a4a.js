        ...
        var l = {
            ...
            construct: function (t) {
                ...
                if ("accordion" !== r.getSubmenuMode(e)) {
                    ...
                    if (a.length > 0 && !1 === KTUtil.hasClass(e, "menu-toggle") && 0 === e.querySelectorAll(".menu-toggle").length)for (var n = 0,
                                                                                                                                             o = a.length; n < o; n++)r.hideSubmenuDropdown(a[0], !0)
                }
                ...
                var t;
                if (t = i.querySelectorAll('.menu-item-submenu.menu-item-hover:not(.menu-item-tabs):not([data-menu-toggle="tab"])'))for (var e = 0,
                                                                                                                                             a = t.length; e < a; e++)r.hideSubmenuDropdown(t[e], !0)
                ...
                r.resetActiveItem();
                for (var e = KTUtil.parents(t, ".menu-item-submenu") || [], a = 0,
                         n = e.length; a < n; a++)KTUtil.addClass(e[a], "menu-item-open");
...
"undefined" != typeof module && void 0 !== module.exports && (module.exports = KTMenu), document.addEventListener("click", function (t) {
    var e;
    if (e = KTUtil.getByTagName("body")[0].querySelectorAll('.menu-nav .menu-item.menu-item-submenu.menu-item-hover:not(.menu-item-tabs)[data-menu-toggle="click"]'))for (var a = 0,
                                                                                                                                                                              n = e.length; a < n; a++) {
...
var KTToggle = function (t, e) {
    var a = this, n = KTUtil.getById(t);
    if (n) {
        var i = {targetToggleMode: "class"}, o = {
            construct: function (t) {
                return KTUtil.data(n).has("toggle") ? a = KTUtil.data(n).get("toggle") : (o.init(t), o.build(), KTUtil.data(n).set("toggle", a)), a
            }, init: function (t) {
                a.element = n, a.events = [], a.options = KTUtil.deepExtend({}, i, t), a.target = KTUtil.getById(t.target), a.targetState = a.options.targetState, a.toggleState = a.options.toggleState, "class" == a.options.targetToggleMode ? a.state = KTUtil.hasClasses(a.target, a.targetState) ? "on" : "off" : a.state = KTUtil.hasAttr(a.target, "data-" + a.targetState) ? KTUtil.attr(a.target, "data-" + a.targetState) : "off"
            }, build: function () {
                ...
                return o.eventTrigger("beforeOn"), "class" == a.options.targetToggleMode ? KTUtil.addClass(a.target, a.targetState) : KTUtil.attr(a.target, "data-" + a.targetState, "on"), a.toggleState && KTUtil.addClass(n, a.toggleState), a.state = "on", o.eventTrigger("afterOn"), o.eventTrigger("toggle"), a
            }, toggleOff: function () {
                return o.eventTrigger("beforeOff"), "class" == a.options.targetToggleMode ? KTUtil.removeClass(a.target, a.targetState) : KTUtil.removeAttr(a.target, "data-" + a.targetState), a.toggleState && KTUtil.removeClass(n, a.toggleState), a.state = "off", o.eventTrigger("afterOff"), o.eventTrigger("toggle"), a
            }, eventTrigger: function (t) {
                for (var e = 0; e < a.events.length; e++) {
                    var n = a.events[e];
                    if (n.name == t) {
...
"undefined" != typeof module && void 0 !== module.exports && (module.exports = KTToggle), Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), Element.prototype.closest || (Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), Element.prototype.closest = function (t) {
    ...
    for (var t = 0, e = ["webkit", "moz"],
             a = 0; a < e.length && !window.requestAnimationFrame; ++a)window.requestAnimationFrame = window[e[a] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[e[a] + "CancelAnimationFrame"] || window[e[a] + "CancelRequestAnimationFrame"];
...
var KTUtil = function () {
    ...
    return {
        init: function (t) {
            ...
            if (t) {
                for (var a = e.split(" "),
                         n = 0; n < a.length; n++)if (0 == KTUtil.hasClass(t, KTUtil.trim(a[n])))return !1;
                return !0
            }
            ...
            Element.prototype.matches || (Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector || function (t) {
                    for (var e = (this.document || this.ownerDocument).querySelectorAll(t),
                             a = e.length; --a >= 0 && e.item(a) !== this;);
                    return a > -1
                });
            ...
            if (t && t.childNodes) {
                for (var n = [], i = 0,
                         o = t.childNodes.length; i < o; ++i)1 == t.childNodes[i].nodeType && KTUtil.matches(t.childNodes[i], e, a) && n.push(t.childNodes[i]);
                return n
            }
        ...
        }, outerHeight: function (t, e=!1) {
            var a, n = t.offsetHeight;
            return e ? (a = getComputedStyle(t), n += parseInt(a.marginTop) + parseInt(a.marginBottom)) : n
        }, visible: function (t) {
            ...
            for (var a = ["webkit-", "moz-", "ms-", "o-", ""],
                     n = 0; n < a.length; n++)KTUtil.css(t, a[n] + "animation-delay", e)
        }, animateDuration: function (t, e) {
            for (var a = ["webkit-", "moz-", "ms-", "o-", ""],
                     n = 0; n < a.length; n++)KTUtil.css(t, a[n] + "animation-duration", e)
            ...
            for (var e = (t += "").split("."), a = e[0], n = e.length > 1 ? "." + e[1] : "",
                     i = /(\d+)(\d{3})/; i.test(a);)a = a.replace(i, "$1,$2");
            return a + n
        }, detectIE: function () {
            ...
            function a() {
                ...
                if (i.length > 0 && i.forEach(function (a) {
                    ...
                    }), !1 !== (n = e.height instanceof Function ? e.height.call() : e.mobileHeight ? parseInt(e.mobileHeight) : parseInt(e.height)))if (n = parseInt(n), !e.mobileNativeScroll && !e.disableForMobile || !0 !== KTUtil.isMobileDevice())if (n > 0 && KTUtil.css(t, "height", n + "px"), e.desktopNativeScroll) KTUtil.css(t, "overflow", "auto"); else {
            ...
            var a = function (t, e) {
                var a = parseInt(t, 16) - e, n = a < 0 ? 0 : a;
                return n = n.toString(16).length > 1 ? n.toString(16) : `0${n.toString(16)}`
            };
            return t = t.indexOf("#") >= 0 ? t.substring(1, t.length) : t, e = parseInt(255 * e / 100), `#${a(t.substring(0, 2), e)}${a(t.substring(2, 4), e)}${a(t.substring(4, 6), e)}`
        }, colorLighten: function (t, e) {
            var a = function (t, e) {
                var a = parseInt(t, 16) + e, n = a > 255 ? 255 : a;
                return n = n.toString(16).length > 1 ? n.toString(16) : `0${n.toString(16)}`
            };
            return t = t.indexOf("#") >= 0 ? t.substring(1, t.length) : t, e = parseInt(255 * e / 100), `#${a(t.substring(0, 2), e)}${a(t.substring(2, 4), e)}${a(t.substring(4, 6), e)}`
        ...
        }, btnWait: function (t, e, a, n=!0) {
            if (t && (n && KTUtil.attr(t, "disabled", !0), e && (KTUtil.addClass(t, e), KTUtil.attr(t, "wait-class", e)), a)) {
    ...
    if (n) {
        var i = {startStep: 1, clickableSteps: !1}, o = {
            construct: function (t) {
                ...
                a.element = n, a.events = [], a.options = KTUtil.deepExtend({}, i, t), a.steps = KTUtil.findAll(n, '[data-wizard-type="step"]'), a.btnSubmit = KTUtil.find(n, '[data-wizard-type="action-submit"]'), a.btnNext = KTUtil.find(n, '[data-wizard-type="action-next"]'), a.btnPrev = KTUtil.find(n, '[data-wizard-type="action-prev"]'), a.btnLast = KTUtil.find(n, '[data-wizard-type="action-last"]'), a.btnFirst = KTUtil.find(n, '[data-wizard-type="action-first"]'), a.events = [], a.currentStep = 1, a.stopped = !1, a.totalSteps = a.steps.length, a.options.startStep > 1 && o.goTo(a.options.startStep), o.updateUI()
            }, build: function () {
                ...
                if (console.log("go to:" + t), !(t === a.currentStep || t > a.totalSteps || t < 0)) {
                    var n;
                ...
                if (n && n.length > 0)for (var i = 0,
                                               l = n.length; i < l; i++)i == e ? KTUtil.attr(n[i], "data-wizard-state", "current") : i < e ? KTUtil.attr(n[i], "data-wizard-state", "done") : KTUtil.attr(n[i], "data-wizard-state", "pending");
    ...
    t.fn.KTDatatable = function (i) {
        if (0 !== t(this).length) {
            ...
            var l = {
                ...
                init: function (e) {
                    var a, n = !1;
                    null === e.data.source && (l.extractTable(), n = !0), l.setupBaseDOM.call(), l.setupDOM(o.table), t(o).on("datatable-on-layouts-updated", l.afterRender), o.debug && l.stateRemove(l.stateId), l.setDataSourceQuery(l.getOption("data.source.read.params.query")), t.each(l.getOption("extensions"), function (e, a) {
                ...
                layoutUpdate: function () {
                    l.setupSubDatatable.call(), l.setupSystemColumn.call(), l.setupHover.call(), void 0 === i.detail && 1 === l.getDepth() && l.lockTable.call(), l.resetScroll(), l.isLocked() || (l.redraw.call(), l.isSubtable() || !0 !== l.getOption("rows.autoHide") || l.autoHide(), t(o.table).find(".datatable-row").css("height", "")), l.columnHide.call(), l.rowEvenOdd.call(), l.sorting.call(), l.scrollbar.call(), l.isInit || (l.dropdownFix(), t(o).trigger("datatable-on-init", {
                        ...
                        options: i
                    }), l.isInit = !0), t(o).trigger("datatable-on-layouts-updated", {table: t(o.wrap).attr("id")})
                },
                ...
                adjustCellsHeight: function () {
                    t.each(t(o.table).children(), function (e, a) {
                        for (var n = t(a).find(".datatable-row").first().parent().find(".datatable-row").length,
                                 i = 1; i <= n; i++) {
                ...
                paging: function (e, n) {
                    var i = {
                        ...
                        populate: function () {
                            ...
                            var n = t("<ul/>").addClass("datatable-pager-nav mb-5 mb-sm-0");
                ...
                autoHide: function () {
                    ...
                    setTimeout(function () {
                        t(o.table).find(".datatable-cell").show(), t(o.tableBody).each(function () {
                            for (var a = 0; t(this)[0].offsetWidth < t(this)[0].scrollWidth && a < i.columns.length;)t(o.table).find(".datatable-row").each(function (a) {
                ...
                destroy: function () {
                    ...
                    return t(o).replaceWith(e), t(o = e).trigger("datatable-on-destroy"), l.isInit = !1, e = null
                },
                sort: function (e, a) {
    ...
    t.fn.KTDatatable = t.fn.KTDatatable || {}, t.fn.KTDatatable.checkbox = function (e, a) {
        var n = {
            selectedAllRows: !1, selectedRows: [], unselectedRows: [], init: function () {
                ...
                }), n.selectedAllRows = e.getDataSourceParam(a.vars.selectedAllRows), t(e).on("datatable-on-layouts-updated", function (a, i) {
...
var KTLayoutAsideMenu = function () {
    ...
    return {
        init: function (a) {
            var n, i;
            (t = KTUtil.getById(a)) && (i = "1" === KTUtil.attr(t, "data-menu-dropdown") ? "dropdown" : "accordion", "1" === KTUtil.attr(t, "data-menu-scroll") && (n = {
                rememberPosition: !0,
                height: function () {
                    var e = parseInt(KTUtil.getViewPort().height);
                    return KTUtil.isBreakpointUp("lg") && (e -= KTLayoutBrand.getHeight()), e -= parseInt(KTUtil.css(t, "marginBottom")) + parseInt(KTUtil.css(t, "marginTop"))
                }
            }), (e = new KTMenu(t, {
                scroll: n,
                ...
                if (!0 === KTLayoutAside.isMinimized() && !1 === KTLayoutAside.isHoverable())return !1
            }), e.on("linkClick", function (t) {
...
var KTLayoutAsideToggle = function () {
    ...
    return {
        init: function (n) {
            e = KTUtil.getById(n), t = KTUtil.getBody(), e && ((a = new KTToggle(e, {
                target: t,
...
var KTLayoutAside = function () {
    ...
    return {
        init: function (n) {
            var i, o, l;
            (e = KTUtil.getById(n), t = KTUtil.getBody(), e) && (l = KTUtil.hasClass(e, "aside-offcanvas-default") ? "aside-offcanvas-default" : "aside", a = new KTOffcanvas(e, {
                baseClass: l,
                overlay: !0,
                ...
                e.preventDefault(), !1 !== KTUtil.isBreakpointUp("lg") && (o && (clearTimeout(o), o = null), i = setTimeout(function () {
                    KTUtil.hasClass(t, "aside-minimize") && KTUtil.isBreakpointUp("lg") && (KTUtil.removeClass(t, "aside-minimize"), KTUtil.addClass(t, "aside-minimize-hover"), KTLayoutAsideMenu.getMenu().scrollUpdate(), KTLayoutAsideMenu.getMenu().scrollTop())
                }, 50))
            }), KTUtil.addEvent(e, "mouseleave", function (e) {
                e.preventDefault(), !1 !== KTUtil.isBreakpointUp("lg") && (i && (clearTimeout(i), i = null), o = setTimeout(function () {
                    KTUtil.hasClass(t, "aside-minimize-hover") && KTUtil.isBreakpointUp("lg") && (KTUtil.removeClass(t, "aside-minimize-hover"), KTUtil.addClass(t, "aside-minimize"), KTLayoutAsideMenu.getMenu().scrollUpdate(), KTLayoutAsideMenu.getMenu().scrollTop())
                }, 100))
            })))
        }, getElement: function () {
            return e
...
var KTLayoutContent = function () {
    ...
    return {
        init: function (e) {
            ...
            return e = KTUtil.getViewPort().height, t && (e = e - parseInt(KTUtil.css(t, "paddingTop")) - parseInt(KTUtil.css(t, "paddingBottom"))), e -= KTLayoutHeader.getHeight(), e -= KTLayoutSubheader.getHeight(), e -= KTLayoutFooter.getHeight();
            var e
        }, getElement: function () {
            return t
        }
...
var KTLayoutHeaderTopbar = function () {
    ...
    return {
        init: function (e) {
            (t = KTUtil.getById(e)) && new KTToggle(t, {
...
var KTLayoutExamples = {
    init: function (t, e) {
        !function (t) {
            var e = t;
            void 0 === e && (e = document.querySelectorAll(".example:not(.example-compact):not(.example-hover):not(.example-basic)"));
    ...
    return {
        init: function (e) {
            ...
            (t = KTUtil.getById(e)) && (a = KTUtil.find(t, ".offcanvas-header"), n = KTUtil.find(t, ".offcanvas-content"), new KTOffcanvas(t, {
                ...
                height: function () {
                    var e = parseInt(KTUtil.getViewPort().height);
                    return a && (e -= parseInt(KTUtil.actualHeight(a)), e -= parseInt(KTUtil.css(a, "marginTop")), e -= parseInt(KTUtil.css(a, "marginBottom"))), n && (e -= parseInt(KTUtil.css(n, "marginTop")), e -= parseInt(KTUtil.css(n, "marginBottom"))), e -= parseInt(KTUtil.css(t, "paddingTop")), e -= parseInt(KTUtil.css(t, "paddingBottom")), e -= 2
                }
            }))
        }, getElement: function () {
            return t
...
var KTLayoutSearch = function () {
    var t, e, a, n, i, o, l, r, s = "", d = !1, c = !1, u = !1, p = "quick-search-has-result", f = function () {
        u = !1, KTUtil.removeClass(r, "spinner spinner-sm spinner-primary"), n && (a.value.length < 2 ? KTUtil.hide(n) : KTUtil.show(n, "flex"))
    }, g = function () {
        l && !KTUtil.hasClass(o, "show") && ($(l).dropdown("toggle"), $(l).dropdown("update"))
    }, m = function () {
        l && KTUtil.hasClass(o, "show") && $(l).dropdown("toggle")
    }, h = function () {
        if (d && s === a.value)return f(), KTUtil.addClass(t, p), g(), void KTUtil.scrollUpdate(i);
        s = a.value, KTUtil.removeClass(t, p), u = !0, KTUtil.addClass(r, "spinner spinner-sm spinner-primary"), n && KTUtil.hide(n), m(), setTimeout(function () {
            $.ajax({
                url: HOST_URL + "/api/quick_search.php", data: {query: s}, dataType: "html", success: function (e) {
                    d = !0, f(), KTUtil.addClass(t, p), KTUtil.setHTML(i, e), g(), KTUtil.scrollUpdate(i)
                }, error: function (e) {
                    d = !1, f(), KTUtil.addClass(t, p), KTUtil.setHTML(i, '<span class="font-weight-bold text-muted">Connection error. Please try again later..</div>'), g(), KTUtil.scrollUpdate(i)
                }
            })
        }, 1e3)
    }, v = function (e) {
        a.value = "", s = "", d = !1, KTUtil.hide(n), KTUtil.removeClass(t, p), m()
    }, b = function () {
